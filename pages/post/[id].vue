    ...
    >
        ...
        <div class="flex items-center">
          <NuxtLink href="/">
            <Avatar
              ...
              image-height="40"
              image-width="40"
              image-src="https://picsum.photos/id/8/300/300"
            />
          </NuxtLink>
      ...
      <div class="flex items-center px-8 mt-8">
        <div class="pb-4 text-center flex items-center">
          <button class="rounded-full bg-gray-200 p-2 cursor-pointer h-10 w-10">
          ...
          <div class="flex items-center relative w-full">
            ...
            <div class="ml-14 pt-0.5 w-full">
              ...
              <div class="text-[15px] font-light">
                ...
                facere optio repudiandae minima nihil molestias vel voluptatem
                delectus voluptas distinctio, sunt laudantium ab esse inventore
                recusandae architecto doloremque! Doloremque.
              </div>
            </div>
          </div>
        </div>
      ...
      >
        ...
        <button
          :disabled="!comment"
          @click="addComment"
          :class="comment ? 'text-primary cursor-pointer' : 'text-gray-400'"
